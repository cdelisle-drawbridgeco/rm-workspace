  ...
  return (
    <div className="grid grid-cols-3 gap-0 border-b border-gray-100 last:border-0">
      ...
      <div className="px-3 py-3 border-l border-gray-100">
        <p className="text-xs text-gray-700 leading-relaxed">{drawbridgeText}</p>
      </div>
      <div className="px-3 py-3 border-l border-gray-100">
        <p className="text-xs text-gray-500 leading-relaxed">{mspText}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <>
      ...
      <div className="mt-6 grid grid-cols-4 gap-4">
        ...
        <StatCard label="Portfolio Monitoring Coverage" value="Acquisition to Exit" />
      </div>
      ...
      <p className="text-sm text-gray-700 leading-relaxed mt-3">
        ...
        &mdash; this is not comparable to having access to a platform that continuously provides
        data on cyber oversight across every portfolio company.
      </p>
      <div className="mt-3 rounded-lg border-l-4 border-db-dark bg-db-dark/5 p-4">
        ...
        <p className="text-xs text-gray-700 leading-relaxed">
          ...
          support needed to reduce exposure across every portfolio company &mdash; from pre-deal
          diligence through exit.
        </p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                ...
                every portco &mdash; benchmarked against 1,200+ peers &mdash; answers that question
                with data, not assurances. Sponsors who can&apos;t are increasingly on the back
                foot in fundraising conversations.
              </p>
              <p className="mt-2 text-xs text-gray-500 italic">
                &ldquo;When your LPs ask about cyber risk in the portfolio, what do you show them &mdash; and how confident are you in that answer?&rdquo;
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                ...
                continuous monitoring &mdash; not point-in-time snapshots &mdash; so sponsors can
                identify outliers and systemic risks before they become deal-breakers, valuation
                events, or regulatory problems. The platform tracks remediation progress in real
                time, giving fully transparent updates on what&apos;s getting fixed.
              </p>
              <p className="mt-2 text-xs text-gray-500 italic">
                &ldquo;Do you know which of your portfolio companies would be hardest hit by a cyber incident today &mdash; and what you&apos;d do about it?&rdquo;
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                ...
                for unresolved risk. Sponsors who can show a year-on-year improvement narrative &mdash;
                remediation progress, score trajectory, benchmarked posture &mdash; create a
                materially stronger exit story. Drawbridge is designed to stand up in transactions,
                ODD reviews, and regulatory examinations.
              </p>
              <p className="mt-2 text-xs text-gray-500 italic">
                &ldquo;When a buyer runs cyber DD on your portfolio company, what does that conversation look like &mdash; and are you in front of it?&rdquo;
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                ...
                oversight process &mdash; not just whether individual portcos are compliant.
                Drawbridge gives sponsors a standardized scoring framework and benchmarked evidence
                of oversight across diverse portfolio companies, sectors, and geographies.
              </p>
              <p className="mt-2 text-xs text-gray-500 italic">
                &ldquo;If a regulator or board asked how you oversee cyber risk across your portfolio, could you show them something that goes beyond &lsquo;each company has an MSP&rsquo;?&rdquo;
              </p>
            </div>
          </div>
        </div>
      ...
      <p className="text-sm text-gray-700 leading-relaxed">
        The Drawbridge platform and advisory team deliver continuous coverage at every stage &mdash;
      ...
      {/* ── The Cyber Score ───────────────────────────────── */}
      <SectionHeading>The Cyber Score &mdash; A Governance Tool, Not a Technical Metric</SectionHeading>
      <p className="text-sm text-gray-700 leading-relaxed">
        ...
        simplifies communication &mdash; not analysis. It is backed by detailed findings,
        benchmarking, and remediation tracking within the platform.
      </p>
      <div className="mt-4 grid grid-cols-2 gap-3">
        {[
          ...
          <div key={i} className="rounded-lg border border-gray-200 bg-white p-4">
            <p className="text-xs font-semibold text-db-dark mb-1">{title}</p>
      ...
      {/* ── Drawbridge vs MSP ─────────────────────────────── */}
      <SectionHeading>Drawbridge vs. MSP &mdash; Why It&apos;s Not the Same Thing</SectionHeading>
      <p className="text-sm text-gray-700 leading-relaxed">
      ...
      <div className="mt-4 rounded-lg border border-gray-200 overflow-hidden">
        ...
        <CompareRow
          ...
          drawbridgeText="Fully independent, cyber-only provider. No incentive to oversell or underplay risk. Findings are trusted because they are conflict-free."
          mspText="MSPs assess controls they design, manage, or remediate. Weak findings can reflect badly on their own services — results are often softened or normalized."
        />
        <CompareRow
          dimension="Purpose"
          drawbridgeText="Designed explicitly for governance, portfolio oversight, and LP, board, and buyer conversations."
          mspText="Typically a by-product of IT monitoring. Designed to support operational IT decisions — rarely built for investor or board communication."
        />
        <CompareRow
          dimension="Portfolio Consistency"
          drawbridgeText="One scoring framework applied consistently across all portcos, sectors, and geographies. Enables true cross-portfolio comparison."
          mspText="Different MSPs across portfolio companies = different methodologies. Scores not comparable across entities."
        />
        <CompareRow
          dimension="Benchmarking Depth"
          drawbridgeText="Benchmarked against 1,200+ alternative investment firms. Contextualized by firm size, structure, and maturity. Custom peer group selection available."
          mspText="Benchmarks usually limited to tool baselines or generic industry standards — often opaque or proprietary to the MSP."
        />
        <CompareRow
          dimension="Time Horizon"
          drawbridgeText="Continuous scoring. Tracks progress as remediation is completed. Supports year-on-year improvement narratives."
          mspText="Point-in-time snapshots, often tied to audits, renewals, or incidents. Limited ability to show improvement over time."
        />
        <CompareRow
          dimension="LP & Exit Credibility"
          drawbridgeText="Recognized across LP due diligence, ODD reviews, regulatory examinations. Designed to stand up in transactions."
          mspText="LPs may question independence. Buyers may discount internally generated scores. Limited recognition in ODD and exit processes."
        />
      </div>
      ...
      <SubSection icon="🛡️" title="Objection Handling">
        <p className="text-sm text-gray-700 leading-relaxed">
          Common pushbacks from PE sponsors and operating partners &mdash; with the right responses.
        </p>
        <div className="mt-3 space-y-3">
          {[
            ...
            <div key={i} className="rounded-lg border border-gray-200 p-4">
              <p className="text-xs font-semibold text-gray-800 mb-1">&ldquo;{objection}&rdquo;</p>
      ...
      <DrawbridgeAngle>
        <p>
          Portfolio Analytics is one of the most distinctive capabilities Drawbridge has built &mdash;
        ...
        <p className="mt-2">
          The RM angle here is that the conversation isn&apos;t really about cybersecurity &mdash;
          it&apos;s about investment risk, LP trust, and exit value. Cyber risk is investment risk.
          Every quarter that a portfolio company sits unscored and unmonitored is a quarter of
          exposure that could show up at the worst possible moment: in a deal process, an LP
          review, or a regulatory examination.
        </p>
        <p className="mt-2">
          The firms that answer LP cyber questions with data and benchmarks &mdash; instead of
          assurances and MSP reports &mdash; are the ones that stand out.{' '}
          <strong>Raise Your Guard, Raise Your Score, Raise Your Bar.</strong>{' '}
          That&apos;s the value narrative for every PE sponsor conversation.
        </p>
      </DrawbridgeAngle>
    </>
  );
